...
import { createRoom, joinRoom, startSession, getSession, submitSwipe, restartSession } from "../controllers/room.controller.js";
...
router.post("/:roomCode/restart", authMiddleware, validate(startSessionSchema, "params"), restartSession);
